...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=16&duration=3000&pause=99999999&color=56d364&center=true&vCenter=true&repeat=false&width=700&lines=Welcome.+The+clusters+are+running.+Please%2C+come+in.+%F0%9F%8E%A9)](https://git.io/typing-svg)
...
```bash
❯ whoami
  muigai-edwin -> cloud engineer, container wrangler : containerizing chaos, serving order 

❯ cat philosophy.txt
  "If it runs once manually, it can run a thousand times automatically."
  "A gentleman ships to production. A butler ensures it rolls back gracefully. "
...
❯ echo $CURRENT_MISSION
  GCP mastery → Kubernetes at scale → serving production with precision 
```
...
| [Kubernetes](https://github.com/MuigaiEdwin/k8s-kvm-lab)| orchestration | 🔜 Deploying soon |
